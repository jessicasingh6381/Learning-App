...
use App\Http\Controllers\LessonExperienceController;
...
Route::middleware(['auth', 'admin.user', 'tenant'])->group(function () {
    ...
    Route::post('/learning-plan/enrollments/{enrollment}/curriculum-imports/{curriculumImport}/lesson-plans', [LessonPlanController::class, 'store'])->name('lesson-plans.store');
    Route::get('/lesson-plans/{lessonPlan}', [LessonPlanController::class, 'show'])->name('lesson-plans.show');
    Route::post('/lesson-plans/{lessonPlan}/review', [LessonPlanController::class, 'review'])->name('lesson-plans.review');
    Route::post('/lesson-plans/{lessonPlan}/approve', [LessonPlanController::class, 'approve'])->name('lesson-plans.approve');
    Route::post('/lesson-plans/{lessonPlan}/units/{unit}/generate', [LessonPlanController::class, 'generateUnit'])->name('lesson-plans.units.generate');
    Route::get('/lesson-plans/{lessonPlan}/lessons/{lesson}', [LessonController::class, 'show'])->name('lesson-plans.lessons.show');
    Route::post('/lesson-plans/{lessonPlan}/lessons/{lesson}/review', [LessonController::class, 'review'])->name('lesson-plans.lessons.review');
    Route::post('/lesson-plans/{lessonPlan}/lessons/{lesson}/approve', [LessonController::class, 'approve'])->name('lesson-plans.lessons.approve');
    Route::get('/lesson-plans/{lessonPlan}/lessons/{lesson}/student-preview', [LessonExperienceController::class, 'preview'])->name('lesson-plans.lessons.experience-preview');
    Route::post('/lesson-plans/{lessonPlan}/lessons/{lesson}/student-preview/{progress}/activities/{activity}', [LessonExperienceController::class, 'respondPreview'])->name('lesson-plans.lessons.experience-preview.respond');
    Route::post('/lesson-plans/{lessonPlan}/lessons/{lesson}/student-preview/{progress}/activities/{activity}/draft', [LessonExperienceController::class, 'saveDraftPreview'])->name('lesson-plans.lessons.experience-preview.draft');
    Route::get('/lesson-plans/{lessonPlan}/lessons/{lesson}/resources/{resource}', [LessonResourceController::class, 'teacher'])->name('lesson-plans.lessons.resources.show');
...
Route::middleware(['auth', 'student.access'])->prefix('student')->name('student.')->group(function () {
    ...
    Route::middleware('student.password')->group(function () {
        ...
        Route::get('/lessons/{lesson}/resources/{resource}', [LessonResourceController::class, 'student'])->name('lessons.resources.show');
