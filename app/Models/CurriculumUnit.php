...
class CurriculumUnit extends Model
{
    protected $fillable = [
        ...
        'planned_start_date', 'planned_end_date', 'estimated_days', 'unit_type', 'included', 'metadata',
    ...
    protected function casts(): array { return ['sequence' => 'integer', 'planned_start_date' => 'date:Y-m-d', 'planned_end_date' => 'date:Y-m-d', 'estimated_days' => 'integer', 'included' => 'boolean', 'metadata' => 'array', 'source_confidence' => 'float']; }
